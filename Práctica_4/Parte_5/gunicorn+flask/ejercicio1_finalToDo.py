...
autorizados = {}  # usuario -> hash de contraseña
...
def verificar(usuario, contraseña):
    # Esta función debe retornar True si el usuario/contraseña es válido
    # y False en caso contrario. Depende de la variable global 'autorizados'.
    if not usuario or not contraseña:
        return False

    hash_guardado = autorizados.get(usuario)
